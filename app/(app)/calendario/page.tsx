...
const YEAR = 2026
const MONTH_LABEL = "Junho de 2026"
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6">
      <div>
        ...
        <p className="mt-1 text-muted-foreground">Acompanhe suas aulas ao vivo, provas e eventos da comunidade ESC.</p>
      </div>
              ...
              return (
                <div key={e.id} className="flex items-start gap-3 rounded-lg border border-border p-3">
                  <div className="flex h-11 w-11 shrink-0 flex-col items-center justify-center rounded-md bg-secondary text-center">
                    ...
                    <span className="text-[10px] uppercase text-muted-foreground">Jun</span>
                  </div>
